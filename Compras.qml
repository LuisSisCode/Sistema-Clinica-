...
Item {
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            // ⚠️ ADVERTENCIA DE MARGEN BAJO - NUEVO COMPONENTE
            Rectangle {
                id: advertenciaMargenBajo
                Layout.fillWidth: true
                Layout.preferredHeight: visible ? 140 : 0
                visible: {
                    // Verificar si hay productos con margen < 10%
                    for (var i = 0; i < detallesCompraModel.count; i++) {
                        if ((detallesCompraModel.get(i).margen_porcentaje || 0) < 10) {
                            return true
                        }
                    }
                    return false
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ColumnLayout {
                            ...
                            Label {
                                text: "Uno o más productos tienen un margen de ganancia menor al 10%"
                                color: "#F57C00"
                                font.pixelSize: 11
                                wrapMode: Text.WordWrap
                                Layout.fillWidth: true
                        ...
                        ColumnLayout {
                            ...
                            Repeater {
                                ...
                                Rectangle {
                                    Layout.fillWidth: true
                                    Layout.preferredHeight: 60
                                    visible: (model.margen_porcentaje || 0) < 10
                                    color: "#FFFFFF"
                                    radius: 6
                                    border.color: "#FFB74D"
                                    border.width: 1
                                    ...
                                    RowLayout {
                                        ...
                                        ColumnLayout {
                                            ...
                                            RowLayout {
                                                ...
                                                Label {
                                                    text: "Compra: Bs " + (model.precio_unitario || 0).toFixed(2)
                                                    color: "#E74C3C"
                                                    font.pixelSize: 10
                                                }
                                                
                                                Label {
                                                    text: "Venta actual: Bs " + (model.precio_venta_actual || 0).toFixed(2)
                                                    color: "#7F8C8D"
                                                    font.pixelSize: 10
                                                }
                                                ...
                                                Rectangle {
                                                    ...
                                                    Label {
                                                        anchors.centerIn: parent
                                                        text: (model.margen_porcentaje || 0).toFixed(1) + "%"
                                                        color: "#C62828"
                                                        font.bold: true
                                                        font.pixelSize: 9
                                                    }
                                        ...
                                        Rectangle {
                                            ...
                                            ColumnLayout {
                                                ...
                                                Label {
                                                    text: "Bs " + ((model.precio_unitario || 0) * 2).toFixed(2)
                                                    color: "#1B5E20"
                                                    font.bold: true
                                                    font.pixelSize: 16
                                                    Layout.alignment: Qt.AlignHCenter
